...
```javascript
dabs2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-dabs2@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-strided-special-dabs2/tags). For example,

```javascript
dabs2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-dabs2@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dabs2 = require( 'path/to/vendor/umd/math-strided-special-dabs2/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-dabs2@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/math-strided-special-dabs2/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-strided-special-dabs2/actions/workflows/test.yml?query=branch:v0.2.2
...
[deno-readme]: https://github.com/stdlib-js/math-strided-special-dabs2/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-strided-special-dabs2/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-strided-special-dabs2/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-strided-special-dabs2/tree/esm
[esm-readme]: https://github.com/stdlib-js/math-strided-special-dabs2/blob/esm/README.md
